...
departments <- read_rds("../dashboard/data/departments.rds")
...
# Read in raw shapes
buildings_usac <- sf::read_sf("../dashboard/data/usac.osm", layer = "multipolygons") %>%
  print()
...
usac_zones <- sf::read_sf("../dashboard/data/usac/zonas/zonas_usac.shp") %>%
...
centers %>%
  ...
  labs(
    title = "Ubicación de centros universitarios y campus central",
    x = NULL,
    y = NULL
  )
```
...
usac_zones %>%
  ...
  labs(
    title = "Zonificación del campus central",
    x = NULL,
    y = NULL
  )
```
...
buildings %>%
  ...
  labs(
    title = "Zonificación del campus central",
    subtitle = "Referencia de IDs de edificios en tabla en siguiente página.",
    x = NULL, 
    y = NULL
  )
```
